...
public class MainClass02 {
	/*
	 * 콜솔창에 "안녕하세요" 를 출력하려고 한다.
	 * 
	 * 해당 목표를 달성하려면 콘솔창에 출력을 할수 있는 기능을 가진 객체가 필요하다.
	 *
	 * 그 객체는 어디에 있나? System 클래스의 out 이라는 static 필드에 해당객체의
	 * 참조값(키값)이 들어 있다.
	 * 
	 * 그객체는 무슨 type 인가? PrintStream type 이다.
	 * 
	 ...
	 * 마치 기본 클래스 처럼 import 없이 사용할 수 있다.
	 * 
	 */
public MainClass02() {
	System.out.println("안녕하세요");
	//다중 정이(overloading) 된 println() 메소드 사용해보기
